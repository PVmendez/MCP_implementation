...
export class TodoItemsService {
    ...
    async create(listId: string, createTodoItemDto: CreateTodoItemDto): Promise<TodoItem> {
    ...
    async update(id: string, updateTodoItemDto: UpdateTodoItemDto): Promise<TodoItem> {
